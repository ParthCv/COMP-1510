...
/**
 * Name - class for name of a person.
...
public class Name {
    ...
    public void setFirstName(String frstName) {
        if (frstName.trim().length() > 0) {
            firstName = frstName.substring(0, 1).toUpperCase() 
                    + frstName.substring(1).toLowerCase(); 
        }
    }
    ...
    public void setMiddleName(String mdleName) {
        if (mdleName.trim().length() > 0) {
            middleName = mdleName.substring(0, 1).toUpperCase() 
                    + mdleName.substring(1, mdleName.length()).toLowerCase(); 
        }
    }
    ...
    public void setLastName(String lstName) {
        if (lstName.trim().length() > 0) {
            lastName = lstName.substring(0, 1).toUpperCase() 
                    + lstName.substring(1).toLowerCase(); 
        }
    }
